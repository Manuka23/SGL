...
Public Class EstadosTraslados
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spTraslados_ListadoEstadosMovimientos", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("TEstCodigo")
                    Nombre(i) = rdr("TEstNombre").ToString.Trim
