...
Public Class CategoriasBalance
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spBalanceForrajero_ListaCategorias", con)
        ...
        Try
            ...
            Try
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("Orden").ToString.Trim
                    Nombre(i) = rdr("SubCategoria").ToString.Trim
