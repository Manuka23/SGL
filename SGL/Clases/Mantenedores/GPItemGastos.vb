...
Public Class GPItemGastos
    ...
    Private Sub listado_registros(ByVal Cuenta As String)
        Dim con As New SqlConnection(GetConnectionStringFIN())
        Dim cmd As New SqlCommand("spGPItemGastos_ListadoPorCuenta", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("aaTrxDimCodeID")
                    Nombre(i) = rdr("aaTrxDimCodeDescr").ToString.Trim
    ...
    Public Sub Cargar(ByVal Cuenta As String)
        listado_registros(Cuenta)
    End Sub
