...
Public Class CGPerfiles
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spCGPerfiles_Listado", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("PColID")
                    Usuario(i) = rdr("PColUsuario").ToString.Trim
                    Nombre(i) = rdr("PColNombrePerfil").ToString.Trim
    ...
    Public Sub AgregarPerfil(ByVal Nombre As String)
