...
Public Class TipoFallasDiios
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spAdminDiios_ListadoFallasAsignaciones", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("ADAsgnFallaCodigo").ToString.Trim
                    Nombre(i) = rdr("ADAsgnFallaNombre").ToString.Trim
