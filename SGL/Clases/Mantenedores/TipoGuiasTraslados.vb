...
Public Class TipoGuiasTraslados
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spTipoGuiasTraslados_Listado", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    If rdr("TGuiaCodigo") <> 21 And rdr("TGuiaCodigo") <> 52 Then Continue While
                    ReDim Preserve Codigo(i)
                    ReDim Preserve Nombre(i)

                    Codigo(i) = rdr("TGuiaCodigo")
                    Nombre(i) = rdr("TGuiaNombre").ToString.Trim
