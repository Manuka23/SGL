...
Public Class TipoMovimientos
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spTraslados_ListadoTipoMovimientos", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    If rdr("TMovCodigo") > 2 Then Continue While

                    ReDim Preserve Codigo(i)
                    ReDim Preserve Nombre(i)

                    Codigo(i) = rdr("TMovCodigo")
                    Nombre(i) = rdr("TMovNombre").ToString.Trim
