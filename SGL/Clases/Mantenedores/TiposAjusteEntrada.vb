...
Public Class TiposAjusteEntrada
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spAjustes_ListadoTipos", con)
        Dim rdr As SqlDataReader = Nothing
        Dim i As Integer

        cmd.CommandType = Data.CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@Empresa", Empresa)
        cmd.Parameters.AddWithValue("@Movimiento", 2)       'tipos ajuste de entrada
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("ATipCodigo")
                    Nombre(i) = rdr("ATipNombre").ToString.Trim
