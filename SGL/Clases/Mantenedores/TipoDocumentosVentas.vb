...
Public Class TipoDocumentosVentas
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spVentas_ListadoTiposDocs", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("VDocCodigo").ToString.Trim
                    Nombre(i) = rdr("VDocNombre").ToString.Trim
