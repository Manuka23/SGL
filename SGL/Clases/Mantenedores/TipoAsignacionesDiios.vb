...
Public Class TipoAsignacionesDiios
    ...
    Private Sub listado_registros()
        ...
        Dim cmd As New SqlCommand("spAdminDiios_ListadoTipoAsignaciones", con)
        ...
        Try
            ...
            Try
                ...
                While rdr.Read()
                    ...
                    Codigo(i) = rdr("ADAsgnTipCodigo").ToString.Trim
                    Nombre(i) = rdr("ADAsgnTipNombre").ToString.Trim
