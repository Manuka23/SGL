...
Public Class frmCasa_Editar
    Private Sub frmCasa_Editar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        tbxCasa.Text = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(0).Text
        tbxSitio.Text = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(1).Text
        tbxMedidor.Text = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(2).Text
        cbxResponsable.SelectedItem = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(6).Text
        cbxCentros.SelectedItem = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(4).Text.ToUpper()
        ' cbxCentros.SelectedIndex = General.Centros() frmCasa.lvCasas.SelectedItems.Item(0).SubItems(3).Text
        cbxClasificacion.SelectedItem = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(7).Text
        cbxPoblacion.SelectedItem = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(8).Text
        cbxRelacion.SelectedItem = frmCasa.lvCasas.SelectedItems.Item(0).SubItems(9).Text
    End Sub
    ...
    Private Function Guardar(ByVal _CodCentro As String, ByVal _CodCasa As String, ByVal _CodMedidor As String, ByVal _CodSitio As String, ByVal _CodResponsable As String, ByVal _CodProblacion As String, ByVal _CodRelacion As String, ByVal _CodClasificacion As String)
        ...
        Dim cmd As New SqlCommand("[spLuz_CasaEditar]", con)
