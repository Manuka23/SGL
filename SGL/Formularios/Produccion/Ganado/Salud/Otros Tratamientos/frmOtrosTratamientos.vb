...
Public Class frmOtrosTratamientos
    ...
    Public Sub ConsultaOtrosTratamientos(ByVal cent_ As String)
        lblProcesa.Text = "Consultando datos, espere un momento por favor..."

        Cursor.Current = Cursors.WaitCursor

        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spOtrosTratamientos_ListadoPorCentros", con)
        ...
        Try
            ...
            Try
                While rdr.Read()
                    ...
                    item.SubItems.Add(rdr("SumaOtrosTrat").ToString.Trim)                                'format(rdr("TrasFechaHora"), "dd-MM-yyyy HH:mm"))
                    ...
                    Total_Casos = Total_Casos + rdr("SumaOtrosTrat")
...
SalirProc:
    ...
    Private Sub DetalleOtrosTratamientos()
        ...
        Dim patologia_ As String = lvGanado.SelectedItems(0).SubItems(4).Text       'nombre patologia
        Dim casos_ As String = lvGanado.SelectedItems(0).SubItems(5).Text           '
        Dim tratamientos_ As String = lvGanado.SelectedItems(0).SubItems(6).Text    '
        Dim resguardos_ As String = lvGanado.SelectedItems(0).SubItems(7).Text      '

        'frmOtrosTratamientosDetalle.P1_CodigoCentro = cent_
        'frmOtrosTratamientosDetalle.P2_NombreCentro = nomcent_
        'frmOtrosTratamientosDetalle.P3_FechaDesde = dtpFechaDesde.Value
        'frmOtrosTratamientosDetalle.P4_FechaHasta = dtpFechaHasta.Value

        With frmOtrosTratamientosDetalle
            .P1_NroCasos = Int32.Parse(casos_)
            .P2_NroTratamientos = Int32.Parse(tratamientos_)
            .P3_NroResguardos = Int32.Parse(resguardos_)

            .MdiParent = frmMAIN
            .Show()

            .cboCentros.Text = nomcent_
            .cboPatologias.Text = patologia_
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        ConsultaOtrosTratamientos(cent_)

        'Para Graficos
        ConsultaGraficoAño(cent_, "ANUAL")
    ...
    Private Sub lvGanado_MouseDoubleClick(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles lvGanado.MouseDoubleClick
        ...
        If e.Button = MouseButtons.Left = True Then
            DetalleOtrosTratamientos()
        End If
    End Sub


    Private Sub frmOtrosTratamientos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ConsultaGraficoAño(ByVal centro_ As String, ByVal TipoGrafico As String) 'Para Grafico
        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spOtrosTratamientos_Graficos", con)
        ...
        Try
            ...
            If TipoGrafico = "ANUAL" Then
                ChartOtrosTratAnual.Series("SerieMastitis").Points.DataBindXY(rdrGraphic, "AMes", rdrGraphic, "TotalMast")
            End If
