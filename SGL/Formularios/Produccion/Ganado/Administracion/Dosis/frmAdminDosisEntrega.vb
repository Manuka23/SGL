...
Public Class frmAdminDosisEntrega
    ...
    Public Param4_DosisLibres As Integer
    ...
    Private Function GrabarEntregaDosis() As Boolean
        GrabarEntregaDosis = False

        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spAdminDosis_GrabarEntrega", con)
        ...
        cmd.Parameters.AddWithValue("@FechaEntrega", dtpFecha.Value)
    ...
    Private Function ExisteEntregaDosis() As Boolean
        ExisteEntregaDosis = False

        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spAdminDosis_ExisteEntrega", con)
        Dim rdr As SqlDataReader = Nothing
    ...
    Private Sub btnGrabar_Click(sender As System.Object, e As System.EventArgs) Handles btnGrabar.Click
        ...
        If ExisteEntregaDosis() = True Then
            'CONFIRMAR
            If MsgBox("EL CENTRO YA REGISTRA DOSIS DEL TORO SELECCIONADO" + vbNewLine + vbNewLine + "¿ DESEA AGREGAR DOSIS  ?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "CONFIRMACION") <> MsgBoxResult.Yes Then
                Exit Sub
            End If
            'Else
        ...
        If GrabarEntregaDosis() = True Then
            Cerrar()
    ...
    Private Sub frmAdministracionDiiosAsignacion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        txtNombreToro.Text = Param2_NombreToro
        txtNroLibres.Text = Param4_DosisLibres.ToString
