...
Public Class frmCierresTemporada
    'Private Potreros As New Potreros
    ...
    Public Sub ConsultarCierresTemporada()
        lblProcesa.Text = "Consultando datos, espere un momento por favor..."

        Cursor.Current = Cursors.WaitCursor

        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spCierresTemporada_Listado", con)
        ...
        Try
            ...
            Try
                While rdr.Read()
                    ...
                    item.SubItems.Add(Format(rdr("CTempFechaIni"), "dd-MM-yyyy"))
                    item.SubItems.Add(Format(rdr("CTempFechaFin"), "dd-MM-yyyy"))
                    item.SubItems.Add(rdr("CTempObservs").ToString.Trim)
...
SalirProc:
    ...
    Private Sub frmCierresTemporada_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub EliminarCierreTemporada()
        If lvGanado.SelectedItems.Count = 0 Then Exit Sub

        If MsgBox("¿DESEA ELIMINAR EL CIERRE DE TEMPORADA SELECCIONADO?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "CONFIRMACION") = MsgBoxResult.Yes Then
            If Eliminar_CT() = True Then
                ConsultarCierresTemporada()
            End If
        End If
    End Sub


    Private Function Eliminar_CT() As Boolean
        Eliminar_CT = False

        Dim con As New SqlConnection(GetConnectionString())
        Dim cmd As New SqlCommand("spCierresTemporada_Eliminar", con)
        Dim rdr As SqlDataReader = Nothing

        cmd.CommandType = Data.CommandType.StoredProcedure

        Dim cent_ As String = lvGanado.SelectedItems(0).SubItems(6).Text
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        frmCierresTemporadaIngreso.MdiParent = frmMAIN
        frmCierresTemporadaIngreso.Show()
        frmCierresTemporadaIngreso.BringToFront()

        frmCierresTemporadaIngreso.cboCentros.Text = cboCentros.Text
    End Sub
    ...
    Private Sub frmCierresTemporada_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
