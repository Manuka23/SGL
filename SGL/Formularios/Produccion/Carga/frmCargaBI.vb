...
Public Class frmCargaBI
    ...
    Private Function Guardar(id As String, centro As String, fecha As DateTime, valor As Double) As Double
        ...
        Dim query As String = "insert_carga"
...
#End Region
        ...
        Do While (c < dt.Columns.Count) ''columnas --> centros
            ...
            Do While (f < (dt.Rows.Count))
                ...
                If Not String.IsNullOrWhiteSpace(centro) Then
                    ...
                    Dim TempValor = dt.Rows(f)(c).ToString
                    Dim valor As Double = 0
                    If Not String.IsNullOrWhiteSpace(TempValor) Then
                        valor = Double.Parse(TempValor)
                    End If
    ...
    Private Function BuscarCentrosTodos() As List(Of String)
        ...
        Dim cmd As New SqlCommand("SELECT [CentroCod] FROM [MANUKA_BI].[dbo].[MBI_CentroGrupo]", con)
        Dim rdr = Nothing
        ...
        Try
            ...
            While Data.Read
                If Data.HasRows = True Then
                    Lista.Add(Data(0).ToString().Trim())
                End If
            End While
            Lista.Add(0.ToString()) ' esto es para el caso especial si control =0 entonces tipo=4
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim cmd As New SqlCommand("sp_carga_mensual", con)
        cmd.CommandType = Data.CommandType.StoredProcedure
        ...
        Try
            ...
            If cmd.ExecuteNonQuery() > 0 Then
                MsgBox("DATOS ACTUALIZADOS", MsgBoxStyle.Information + MsgBoxStyle.OkOnly)
