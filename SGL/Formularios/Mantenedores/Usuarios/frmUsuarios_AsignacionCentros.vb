...
Public Class frmAsignacionCentrosUsuarios
    ...
    Private Sub frmAsignacionCentrosUsuarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While rdr.Read()
                ...
                If buscarCen = 1 Then
                    ...
                    If rdr("CenDesCor").ToString.Trim.Contains(TxtCentros.Text) Then
    ...
    Private Sub limpia()
        ...
        contdefault = 0
    End Sub
    Private Sub BuscarCentrosUsuario(ByVal indx As Integer)
        Cursor.Current = Cursors.WaitCursor

        Try
            Dim con As New SqlConnection(GetConnectionString())
            Dim cmd As New SqlCommand("spUsuario_LlenadoCentros", con)
            Dim rdr As SqlDataReader = Nothing
            ...
            While rdr.Read()
                For i = 0 To lvCentros.Items.Count - 1
                    If lvCentros.Items(i).SubItems(2).Text = rdr("CenCod").ToString.Trim() Then
                        lvCentros.Items(i).BackColor = Color.LightGray
                        If rdr("UsuCenTip").ToString.Trim() = "S" Then
    ...
    Private Sub Grabar()
        ...
        For i = 0 To n - 1
            ...
            Cursor.Current = Cursors.WaitCursor
            Dim con As New SqlConnection(GetConnectionString())
            Dim cmd As New SqlCommand("spUsuarios_AsignacionCentros", con)
            Dim rdr As SqlDataReader = Nothing
            ...
            If lvCentros.Items(i).Checked = True Then
                ...
                cmd.Parameters.AddWithValue("@Centro", lvCentros.Items(i).SubItems(2).Text.Trim)
                '
    ...
    Private Sub RemoverCentros()
        ...
        For i = 0 To n - 1
            ...
            Cursor.Current = Cursors.WaitCursor
            Dim con As New SqlConnection(GetConnectionString())
            Dim cmd As New SqlCommand("spUsuario_AsignacionCentrosEliminar", con)
            Dim rdr As SqlDataReader = Nothing
