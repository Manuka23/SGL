...
Public Class fnbalance
    ...
    Public Sub DtExcel(ByVal Fecha As String, ByVal Valor As Decimal, ByVal Centro As String)
        DetallesExcel.Rows.Add(Fecha, Valor, Centro)
    End Sub
    ...
    '    EliminarDetallesExcel.Columns.Add("Valor")
    '    EliminarDetallesExcel.Columns.Add("Centro")
    'End Function

    Public Sub DtExcelCrear()

        DetallesExcel.Columns.Add("Fecha")
        DetallesExcel.Columns.Add("Valor")
        DetallesExcel.Columns.Add("Centro")
