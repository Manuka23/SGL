Public Class frmRptConsultaCelos
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.spGanado_ConsultaGeneral3TableAdapter.Connection.ConnectionString = GetConnectionString()

        Me.spGanado_ConsultaGeneral3TableAdapter.Fill(Me.MANUKA_PROD_DSConsultaCelos.spGanado_ConsultaGeneral3, _
                                                        Empresa, TipoReporte, OtrosCent, Centros, Estados, OtrosCat, Categorias, _
                                                        OtrosEProd, EstsProds, OtrosEReprod, EstsReprods, EstsSalud, DIIO, Dias, FechaDesde, FechaHasta, _
