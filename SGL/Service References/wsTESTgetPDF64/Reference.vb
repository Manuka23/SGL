...
Namespace wsTESTgetPDF64
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="DBNET", ConfigurationName:="wsTESTgetPDF64.getPDF64Soap")>  _
    Public Interface getPDF64Soap
        ...
        Function get_pdf(ByVal request As wsTESTgetPDF64.get_pdfRequest) As wsTESTgetPDF64.get_pdfResponse
        ...
        Function get_pdf_sucursal(ByVal request As wsTESTgetPDF64.get_pdf_sucursalRequest) As wsTESTgetPDF64.get_pdf_sucursalResponse
    End Interface
    ...
    Partial Public Class get_pdfRequest
        ...
        Public Body As wsTESTgetPDF64.get_pdfRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As wsTESTgetPDF64.get_pdfRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class get_pdfResponse
        ...
        Public Body As wsTESTgetPDF64.get_pdfResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As wsTESTgetPDF64.get_pdfResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class get_pdfResponseBody
        ...
        <System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue:=false, Order:=0)>  _
        Public get_pdfResult As wsTESTgetPDF64.ArrayOfString
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal get_pdfResult As wsTESTgetPDF64.ArrayOfString)
            MyBase.New
    ...
    Partial Public Class get_pdf_sucursalRequest
        ...
        Public Body As wsTESTgetPDF64.get_pdf_sucursalRequestBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As wsTESTgetPDF64.get_pdf_sucursalRequestBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class get_pdf_sucursalResponse
        ...
        Public Body As wsTESTgetPDF64.get_pdf_sucursalResponseBody
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal Body As wsTESTgetPDF64.get_pdf_sucursalResponseBody)
            MyBase.New
            Me.Body = Body
        End Sub
    End Class
    ...
    Partial Public Class get_pdf_sucursalResponseBody
        ...
        <System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue:=false, Order:=0)>  _
        Public get_pdf_sucursalResult As wsTESTgetPDF64.ArrayOfString
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal get_pdf_sucursalResult As wsTESTgetPDF64.ArrayOfString)
            MyBase.New
    ...
    Public Interface getPDF64SoapChannel
        Inherits wsTESTgetPDF64.getPDF64Soap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class getPDF64SoapClient
        Inherits System.ServiceModel.ClientBase(Of wsTESTgetPDF64.getPDF64Soap)
        Implements wsTESTgetPDF64.getPDF64Soap
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function wsTESTgetPDF64_getPDF64Soap_get_pdf(ByVal request As wsTESTgetPDF64.get_pdfRequest) As wsTESTgetPDF64.get_pdfResponse Implements wsTESTgetPDF64.getPDF64Soap.get_pdf
            Return MyBase.Channel.get_pdf(request)
        End Function
        
        Public Function get_pdf(ByVal rutt As String, ByVal folio As String, ByVal doc As String, ByVal monto As String, ByVal fecha As String, ByVal ruttt As String, ByVal Merito As Boolean) As wsTESTgetPDF64.ArrayOfString
            Dim inValue As wsTESTgetPDF64.get_pdfRequest = New wsTESTgetPDF64.get_pdfRequest()
            inValue.Body = New wsTESTgetPDF64.get_pdfRequestBody()
            ...
            Dim retVal As wsTESTgetPDF64.get_pdfResponse = CType(Me,wsTESTgetPDF64.getPDF64Soap).get_pdf(inValue)
            Return retVal.Body.get_pdfResult
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function wsTESTgetPDF64_getPDF64Soap_get_pdf_sucursal(ByVal request As wsTESTgetPDF64.get_pdf_sucursalRequest) As wsTESTgetPDF64.get_pdf_sucursalResponse Implements wsTESTgetPDF64.getPDF64Soap.get_pdf_sucursal
            Return MyBase.Channel.get_pdf_sucursal(request)
        End Function
        
        Public Function get_pdf_sucursal(ByVal sRutt As String, ByVal sFolio As String, ByVal sDoc As String, ByVal sMonto As String, ByVal sFecha As String, ByVal sRuttt As String, ByVal bMerito As Boolean) As wsTESTgetPDF64.ArrayOfString
            Dim inValue As wsTESTgetPDF64.get_pdf_sucursalRequest = New wsTESTgetPDF64.get_pdf_sucursalRequest()
            inValue.Body = New wsTESTgetPDF64.get_pdf_sucursalRequestBody()
            ...
            Dim retVal As wsTESTgetPDF64.get_pdf_sucursalResponse = CType(Me,wsTESTgetPDF64.getPDF64Soap).get_pdf_sucursal(inValue)
